 ...
 */
package com.empresa.reto.entity;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByContrasena", query = "SELECT u FROM Usuarios u WHERE u.contraseña = :contrasena")})
public class Usuarios implements Serializable {
    ...
    public String toString() {
        return "com.empresa.reto.entity.Usuarios[ id=" + id + " ]";
    }
